const list = {
  ...
  popup: {
    ...
    edit: {
      ...
      titleImage: "Rename Image",
      labelImage: "Image Title",
      textImage: "Type your desired title of this image and click 'APPLY' to continue.",
    ...
    about: {
      ...
      help: {
        "About Account Security": {
          ...
          "Will my personal information be leaked by HARE?": "All your information is stored on the server, and will not be provided to clients that do not hold your account password or UID and token at the same time. Please note that in addition to your account password, valid or unexpired tokens or session cannot be leaked either, otherwise there is a serious security risk. Under normal website operations not opening the console, you will not unconsciously reveal your token and session. If you want to invalidate the current token or session, please log out directly. If you log out successfully, the server has deleted your current token and session. Please note that token leakage will put your information at the risk of being known by others; session leakage may cause your information on the server to be modified by others.",
          "What information does cookie record in my broswer?": "Cookies store your UID, token information, version, email (if remembered is checked), and other settings. The UID and token information in the cookie is a guarantee for you to re-enter the website within 24 hours after you directly close the page without logging out. It is worth noting that the session does not exist in your cookie, and the session field in the cookie is just a snapshot of the session at a certain moment.",
          "Why does the image of this website sometimes show INVALID ARGUMENT?": "You may open your avatar in a new tab by context menu or copy and pass the image link in booklet gallery to others. But the server will not reveal your personal information for requesting an avatar requires verification of the UID and token in your browser's cookie. If you pass the image URL to someone else, they won’t get the image because they don’t have your token."
        },
        "About Usage": {
  ...
  message: {
    ...
    imageNameError: "The title of the image should be between 1 ~ 16 characters.",
