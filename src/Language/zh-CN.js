    ...
    about: {
      ...
      help: {
        ...
        "关于此应用": {
          ...
          "HARE 的服务是否收费？服务器存储是否可靠？服务器提供多少存储空间？": "HARE 没有收费项目，但是相对的服务器并不是高性能服务器，因此服务提供不稳定。存储的数据可能有遗失的风险，请注意定期导出数据并保存到自己的设备上。默认对于每一位新用户，最多可以创建 8 个记忆组，每个记忆组最多可以创建 16 个记忆册，每个记忆册最多可以创建 64 个词条。每个词条装在请求体中不超过 32KB 即可存储到服务器中。如果达到这个上限，新建按钮将变灰，指示其不可用。",
