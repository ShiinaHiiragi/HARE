const list = {
  ...
  popup: {
    ...
    about: {
      ...
      help: {
        "关于账号安全": {
          "怎么修改账号密码？": "目前作者还在开发核心内容，暂时不支持账号密码修改，敬请关注后续更新。",
          ...
          "我的个人信息是否会被泄露？": "您的信息全部存在服务器，不会向未同时持有您的账号密码或者 UID 和令牌的客户端提供信息。请注意，除了您的账号密码不能泄露，未失效或未过期的令牌也不能泄露，否则有安全风险。在不打开控制台等正常网站操作下，您不会无意中泄露自己的令牌。如果想要使当前令牌失效，请直接退出登录，服务器会删除您当前的令牌。",
