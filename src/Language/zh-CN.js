    ...
    about: {
      ...
      help: {
        ...
        "关于此应用": {
          ...
          "HARE 的版本号是怎么规定的？": "版本号遵循「主版本号·次版本号·补丁」的原则，每修复一个漏洞，补丁版本号加一；每增加一个新功能，次版本号加一；每做出一个破坏性的、不可向下兼容的更新，主版本号加一。事实上，补丁版本号下还有更小的版本号。这个版本号不会显示在日志界面，但是当这个版本号更新时，每次登录网站同样会收到更新提示。"
        }
      }
    }
  },
