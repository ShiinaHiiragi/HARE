  ...
  popup: {
    ...
    about: {
      ...
      help: {
        ...
        // TODO: fill this
        "关于使用方法": {
          "HARE 的主要功能是什么？": "HARE 类似于市面上可以买到的记忆卡片，正面写上单词，背面写上答案，通过自测的形式检验出对知识的掌握程度。在这方面做的比较好的有诸如 Anki 之类的软件，如果不习惯使用本应用，可以尝试其他「记忆卡片」类应用。",
          "什么是记忆组、记忆册和条目？": "（待填写）",
          "回忆是什么？": "（待填写）",
          "回忆时按错了按钮怎么办？": "（待填写，256）",
          "结算界面的等级是怎么规定的？": "等级只按照问题正确率来划分，正确率 100% 为 X；高于 96% 为 S；高于 92% 为 A；高于 84% 为 B；高于 72% 为 C；正确率低于 72% 的记为 D。",
        },
        "关于编辑器": {
